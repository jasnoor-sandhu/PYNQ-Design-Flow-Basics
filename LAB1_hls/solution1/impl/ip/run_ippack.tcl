...
set IPName      "lab_1"
set Version     "1.0"
set DisplayName "Lab_1"
set Revision    "2109221907"
...
set sdx_kernel_name "lab_1"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/jasnoorsandhu/XILINX_Projects/LAB1/LAB1_hls/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {lab_1_AXILiteS_s_axi
lab_1
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 A_V W 0x0 "Data signal of A_V" {{0 32 A_V W 0 "Bit 31 to 0 Data signal of A_V"}}} {0x18 B_V W 0x0 "Data signal of B_V" {{0 32 B_V W 0 "Bit 31 to 0 Data signal of B_V"}}} {0x20 C_V W 0x0 "Data signal of C_V" {{0 32 C_V W 0 "Bit 31 to 0 Data signal of C_V"}}} {0x28 Y_V R 0x0 "Data signal of Y_V" {{0 32 Y_V R 0 "Bit 31 to 0 Data signal of Y_V"}}} {0x2c Y_V_ctrl R 0x0 "Control signal of Y_V" {{0 1 Y_V_ap_vld R 0 "Control signal Y_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
